...
import type { MetadataDef } from '@dust-defi/extension-inject/types';
...
import { ALLOWED_PATH, PASSWORD_EXPIRY_MS } from '@dust-defi/extension-base/defaults';
import chrome from '@dust-defi/extension-inject/chrome';
import { assert, isHex } from '@dust-defi/util';
import { keyExtractSuri, mnemonicGenerate, mnemonicValidate } from '@dust-defi/util-crypto';
